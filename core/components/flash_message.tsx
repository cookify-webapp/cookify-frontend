    ...
    <Observer>
      {() => (
        <div
          ...
          className="bottom-6 fixed bg-white w-[250px] sm:w-[300px] transition-all duration-150 flex items-center rounded-[12px] card-shadow px-4 sm:px-6 border border-success h-[80px] sm:h-[98px]"
        >
